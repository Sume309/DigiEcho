...
// Guard against multiple inclusion when Composer autoload (autoload.files) and manual includes both load this file.
...
class MysqliDb
{
     ...
     * @param string $socket
     */
    public function __construct($host = 'localhost', $username = 'root', $password = '', $db = 'digiecho', $port = null, $charset = 'utf8', $socket = null)
    {
        $isSubQuery = false;
    ...
    public function rawAddPrefix($query){
        ...
        // If no table match is found, return the original query to avoid undefined index notices
