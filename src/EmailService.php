...
class EmailService {
    ...
    public function __construct() {
        // Ensure PHPMailer is available even if autoload wasn't loaded by the caller
        ...
        if (!class_exists(\PHPMailer\PHPMailer\PHPMailer::class)) {
            throw new \Exception('PHPMailer is not installed. Please run composer install in the project root.');
        }
