                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="profile-image-container me-4">
                                            <img id="profileImagePreview" 
                                                 src="<?= !empty($profile['profile_image']) ? 'assets/uploads/profiles/' . $profile['profile_image'] : 'assets/images/default-avatar.svg' ?>" 
                                                 alt="Profile Picture" 
                                        ...
                                        <div>
                                            <input type="file" class="form-control mb-2" id="profileImage" name="profile_image" accept="image/*" style="max-width: 300px;">
                                            <small class="text-muted d-block">Supported formats: JPG, PNG, GIF (Max: 2MB)</small>
                                            <button type="button" class="btn btn-outline-danger btn-sm mt-2" id="removeProfileImage" <?= empty($profile['profile_image']) ? 'style="display: none;"' : '' ?>>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $('#profileImagePreview').attr('src', 'assets/images/default-avatar.svg');
                    $('#profileImage').val('');
                }
            },
            error: function() {
                ...
                // Reset preview on error
                $('#profileImagePreview').attr('src', 'assets/images/default-avatar.png');
                $('#profileImage').val('');
            }
        });
    }
