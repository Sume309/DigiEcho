<?php
// Enhanced Sub-Category Management with Professional Features
ob_start();
...
<body class="sb-nav-fixed">
                                ...
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    ...
                                    <!-- Search -->
                                      <div class="btn-group" role="group">
                                        <a href="subcategory-add.php" class="btn btn-primary btn-sm" style="padding:10px 20px; border:20px; border-radius:500px; cursor:pointer; font-size:20px; font-weight:1000; background:#ae9bb1; color:#fff; margin-left:200px;">
    ...
    // Helper to build action URL safely even if current URL has other query params
    ...
    function deleteSubcategory(id, name) {
        ...
        $.ajax({
            url: buildActionUrl('bulk_delete'),
            type: 'POST',
            data: { ids: [id] },
            success: function(response) {
                if (response.success) {
    ...
    function bindStatusToggleEvents() {
        ...
        $(document).on('click', '.toggle-status', function(e) {
            ...
            $.ajax({
                url: buildActionUrl('toggle_status'),
                type: 'POST',
    ...
    function setupBulkActions(table) {
        $('#bulkDelete').on('click', function() {
            ...
            if (selectedIds.length === 0) {
                Swal.fire({ icon: 'warning', title: 'No Selection', text: 'Please select sub-categories to delete' });
                return;
            }
